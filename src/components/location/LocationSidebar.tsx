...
export function LocationSidebar({ settings, onSettingsChange, selectedLocation, subgroups }: LocationSidebarProps) {
  ...
  return (
    <div className="w-80 border-l bg-white fixed top-0 right-0 bottom-0 overflow-y-auto">
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                value={settings.maxVotesPerUser?.toString() || "unlimited"}
                onChange={(e) => onSettingsChange({
                  ...settings,
                  maxVotesPerUser: e.target.value === "unlimited" ? null : parseInt(e.target.value),
                })}
                className="block w-full rounded-md border border-gray-300 px-3 py-2 text-gray-900 focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900 sm:text-sm"
              >
