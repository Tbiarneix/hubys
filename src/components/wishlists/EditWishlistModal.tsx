...
interface EditWishlistModalProps {
  isOpen: boolean;
  onClose: () => void;
  onEdit: (data: { title: string; description: string | null }) => void;
  wishlist: {
    title: string;
...
export function EditWishlistModal({ isOpen, onClose, onEdit, wishlist }: EditWishlistModalProps) {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-black focus:border-black text-gray-800"
                  rows={4}
                  placeholder="Informations générales sur la liste..."
                />
              </div>
